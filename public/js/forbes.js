...
$.get("/forbes2023aylikfis", function(data) {
...
//-------------------------------------------------------------
// Sunucudan verileri çekme
$.get("/forbes2023aylikciro", function(data) {
    // Veri çekildikten sonra grafik oluşturma
    var labels = [];
    var datasetData = [];
...
//----------------------------------------------------------
// Sunucudan verileri çekme
$.get("/forbes2022aylikciro", function(data) {
    // Veri çekildikten sonra grafik oluşturma
    var labels = [];
    var datasetData = [];
...
// Sunucudan verileri çekme
$.get("/forbes2022aylikfis", function(data) {
    // Veri çekildikten sonra grafik oluşturma
    var countries = [];
    var countryData = [];
    ...
    function fetchData() {
      ...
      fetch(`/forbes_yogunluk?yil=${selectedYear}`)
