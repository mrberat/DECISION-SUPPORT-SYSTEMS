...
$.get("/tinaztepe2023aylikfis", function(data) {
...
//-------------------------------------------------------------
// Sunucudan verileri çekme
$.get("/tinaztepe2023aylikciro", function(data) {
    // Veri çekildikten sonra grafik oluşturma
    var labels = [];
    var datasetData = [];
...
//----------------------------------------------------------
// Sunucudan verileri çekme
$.get("/tinaztepe2022aylikciro", function(data) {
    // Veri çekildikten sonra grafik oluşturma
    var labels = [];
    var datasetData = [];
...
// Sunucudan verileri çekme
$.get("/tinaztepe2022aylikfis", function(data) {
    // Veri çekildikten sonra grafik oluşturma
    var countries = [];
    var countryData = [];
    ...
    function fetchData() {
      ...
      fetch(`/tinaztepe_yogunluk?yil=${selectedYear}`)
