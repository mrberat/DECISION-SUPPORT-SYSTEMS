...
$.get("/bahcelievler2023aylikfis", function(data) {
...
//-------------------------------------------------------------
// Sunucudan verileri çekme
$.get("/bahcelievler2023aylikciro", function(data) {
    // Veri çekildikten sonra grafik oluşturma
    var labels = [];
    var datasetData = [];
...
//----------------------------------------------------------
// Sunucudan verileri çekme
$.get("/bahcelievler2022aylikciro", function(data) {
    // Veri çekildikten sonra grafik oluşturma
    var labels = [];
    var datasetData = [];
...
// Sunucudan verileri çekme
$.get("/bahcelievler2022aylikfis", function(data) {
    // Veri çekildikten sonra grafik oluşturma
    var countries = [];
    var countryData = [];
    ...
    function fetchData() {
      ...
      fetch(`/bahcelievler_yogunluk?yil=${selectedYear}`)
